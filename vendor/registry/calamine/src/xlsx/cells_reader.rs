...
pub struct XlsxCellReader<'a, RS: Read + Seek> {
    xml: XlReader<'a, RS>,
    strings: &'a [String],
...
impl<'a, RS: Read + Seek> XlsxCellReader<'a, RS> {
    pub fn new(
...
fn read_formula<RS: Read + Seek>(xml: &mut XlReader<'_, RS>, e: &BytesStart) -> Result<Option<String>, XlsxError> {
